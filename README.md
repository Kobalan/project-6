...
zenml model-deployer delete mlflow
zenml stack describe
zenml stack set a_new_local_stack
mlflow ui --backend-store-uri "file:C:\Users\User\AppData\Roaming\zenml\local_stores\2aea7ff6-7722-4458-b4b1-b1a05a0723b7\mlruns"
```
