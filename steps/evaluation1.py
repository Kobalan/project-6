...
def evaluation_model1(
    model: ClassifierMixin, x_test: pd.DataFrame, y_test: pd.Series
) :
#->Tuple[Annotated[float, "roc_auc"], Annotated[float, "ACC_score"]]:
    ...
    try:
        ...
        roc_auc =rScore_class.calculate_score(y_test, prediction)
        ...
        with mlflow.start_run(run_name="Binary_Class_Evaluation",nested=True):
